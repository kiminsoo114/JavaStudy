...
public class BooksManager {
	...
	public void booksGetData() {
		try {
			...
			/*
			 * connect() => 실제 URL을 이용해서 웹서버에 접근 parse() => HTML문자열 , 파일
			 */
			/*
			 * <div class="col-md-11 book-list-detail"> <a class="book-url"
			 * href="https://wikibook.co.kr/tf"> <h4 class="main-title">생활코딩 머신러닝 with 파이썬
			 * 텐서플로(실습편)</h4> </a>
			 * 
			 * <div class="col-md-1 book-list-image"> <a href="https://wikibook.co.kr/tf/">
			 * <img src="https://wikibook.co.kr/images/cover/s/9791158392994.jpg">
			 * 
			 * <div class="sub-title">보는 순간 팔로우하고 싶게 만드는</div> <div class="book-info"> <span
			 * class="author">김정은 <small>지음</small></span> | 22,000원 | <span
			 * class="pub-date">2022년 01월 12일 | </span> <span class="isbn"><small>ISBN:
			 * </small>9791158392956</span> <span class="tag"
			 * style="display:none">브랜딩,인스타그램,인스타그램 브랜딩,instagram,branding</span> </div>
			 * <span id="tags"> <i class="fas fa-tags"></i> <a
			 * href="https://wikibook.co.kr/tag/%eb%b8%8c%eb%9e%9c%eb%94%a9/"><span
			 * class="label label-default">브랜딩</span></a> <a href=
			 * "https://wikibook.co.kr/tag/%ec%9d%b8%ec%8a%a4%ed%83%80%ea%b7%b8%eb%9e%a8/"><
			 * span class="label label-default">인스타그램</span></a> <a href=
			 * "https://wikibook.co.kr/tag/%ec%9d%b8%ec%8a%a4%ed%83%80%ea%b7%b8%eb%9e%a8-%eb%b8%8c%eb%9e%9c%eb%94%a9/"
			 * ><span class="label label-default">인스타그램 브랜딩</span></a> <a
			 * href="https://wikibook.co.kr/tag/instagram/"><span
			 * class="label label-default">instagram</span></a> <a
			 * href="https://wikibook.co.kr/tag/branding/"><span
			 * class="label label-default">branding</span></a> </span> </div>
			 */
			...
			/*
			 * <div>값</div> ==> text() <img src="값"> ==> attr("src")
			 */
